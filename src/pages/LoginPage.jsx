...
const LoginPage = () => {
    const { login, loginWithGoogle, isLoading, authorizationError, isAuthenticated } = useAuth();
    const onGoogle = React.useCallback((credential) => { loginWithGoogle(credential).catch(() => {}); }, [loginWithGoogle]);
