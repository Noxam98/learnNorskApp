...
export const T = langGuard({
    ru: {
        ...
        chReview: "повторить", chWeak: "слабых", chNew: "новое", chFormsPhase: "сессия форм", formsDesc: "Партия слов выучена — учим их формы: род, множественное число, времена. Новые слова вернутся, когда формы будут сданы.",
    ...
    en: {
        ...
        chReview: "review", chWeak: "weak", chNew: "new", chFormsPhase: "forms session", formsDesc: "You\u2019ve mastered a batch of words \u2014 now learn their forms: gender, plural, tenses. New words return once the forms are done.",
    ...
    ukr: {
        ...
        chReview: "повторити", chWeak: "слабких", chNew: "нове", chFormsPhase: "сесія форм", formsDesc: "Партію слів вивчено — вчимо їхні форми: рід, множину, часи. Нові слова повернуться, щойно форми буде складено.",
    ...
    pl: {
        ...
        chReview: "powtórka", chWeak: "słabych", chNew: "nowe", chFormsPhase: "sesja form", formsDesc: "Partia słów opanowana — teraz ich formy: rodzaj, liczba mnoga, czasy. Nowe słowa wrócą po zaliczeniu form.",
    ...
    lt: {
        ...
        chReview: "kartoti", chWeak: "silpnų", chNew: "nauja", chFormsPhase: "formų sesija", formsDesc: "Žodžių partija išmokta — mokomės jų formų: giminės, daugiskaitos, laikų. Nauji žodžiai grįš, kai formos bus įveiktos.",
    ...
    lv: {
        ...
        chReview: "atkārtot", chWeak: "vāji", chNew: "jauns", chFormsPhase: "formu sesija", formsDesc: "Vārdu partija apgūta — mācāmies to formas: dzimti, daudzskaitli, laikus. Jauni vārdi atgriezīsies, kad formas būs nokārtotas.",
    ...
    ar: {
        ...
        chReview: "مراجعة", chWeak: "ضعيفة", chNew: "جديدة", chFormsPhase: "جلسة الصيغ", formsDesc: "أتقنت دفعة من الكلمات — الآن تعلّم صيغها: الجنس والجمع والأزمنة. تعود الكلمات الجديدة بعد إتمام الصيغ.",
