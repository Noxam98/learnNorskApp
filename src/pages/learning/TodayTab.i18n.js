...
export const T = langGuard({
    ru: {
        ...
        auditT: "Контрольная проверка", auditD: "Пора освежить {n} выученных слов — проверь, что не забылось.", auditBtn: "Проверить",
    ...
    en: {
        ...
        auditT: "Retention check", auditD: "Time to refresh {n} learned words — check what still sticks.", auditBtn: "Check",
    ...
    ukr: {
        ...
        auditT: "Контрольна перевірка", auditD: "Час освіжити {n} вивчених слів — перевір, що не забулося.", auditBtn: "Перевірити",
    ...
    pl: {
        ...
        auditT: "Kontrola powtórek", auditD: "Czas odświeżyć {n} nauczonych słów — sprawdź, co pamiętasz.", auditBtn: "Sprawdź",
    ...
    lt: {
        ...
        auditT: "Žinių patikra", auditD: "Metas pakartoti {n} išmoktų žodžių — pasitikrink, kas įsiminta.", auditBtn: "Tikrinti",
    ...
    lv: {
        ...
        auditT: "Zināšanu pārbaude", auditD: "Laiks atsvaidzināt {n} apgūtos vārdus — pārbaudi, kas palicis atmiņā.", auditBtn: "Pārbaudīt",
    ...
    ar: {
        ...
        auditT: "مراجعة التذكّر", auditD: "حان وقت تنشيط {n} كلمة تعلّمتها — تحقّق ممّا لا يزال راسخًا.", auditBtn: "تحقّق",
