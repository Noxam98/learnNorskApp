...
const T = langGuard({
    ...
    lv: { done: "Sesija pabeigta", acc: "pareizi", cardsShown: "kartiņu parādīts", shown: "parādīts", masteredLabel: "Apgūts", protectedLabel: "Aizsargāts", protectedTypoLabel: "Aizsargāts ar pārrakstīšanos", of: "no", perSession: "šajā sesijā", levelTo: "Līdz līmenim", maxLevel: "Augstākais līmenis 🎉", streak: "sērija", days: "d.", left: "atlicis šodien", leftZero: "Dienas mērķis sasniegts 🎯", examNote: "Vārdu paka gatava — nokārto eksāmenu, lai atvērtu jaunus", more: "Vēl viena", finish: "Uz Mācībām", words: "vārdi", loading: "Sagatavojam sesiju…", empty: "Pagaidām nav ko mācīties — pievieno vārdus Mācībām" },
    ar: { done: "اكتملت الجلسة", acc: "صحيح", cardsShown: "بطاقات معروضة", shown: "معروضة", masteredLabel: "متعلَّمة", protectedLabel: "محميّة", protectedTypoLabel: "محميّة مع خطأ مطبعي", of: "من", perSession: "هذه الجلسة", levelTo: "حتى المستوى", maxLevel: "أعلى مستوى 🎉", streak: "سلسلة", days: "يوم", left: "متبقٍّ لليوم", leftZero: "اكتمل الهدف اليومي 🎯", examNote: "حزمة كلمات جاهزة — اجتز الاختبار لفتح كلمات جديدة", more: "جلسة أخرى", finish: "إلى الدراسة", words: "كلمات", loading: "نجهّز الجلسة…", empty: "لا شيء للتعلّم بعد — أضف كلمات إلى الدراسة" },
}, "LearningSession.T");
