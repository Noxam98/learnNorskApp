...
export const FORM_LABEL = langGuard({
    ru: { gender: "Какой род (артикль)?", indef_pl: "Мн. число (неопр.)?", present: "Настоящее время?", past: "Прошедшее время?", perfect: "Перфект (har …)?", neuter: "Средний род?", comparative: "Сравнит. степень?", superlative: "Превосх. степень?", plural_adj: "Мн./опр. форма?" },
    en: { gender: "Which article?", indef_pl: "Plural (indefinite)?", present: "Present tense?", past: "Past tense?", perfect: "Perfect (har …)?", neuter: "Neuter form?", comparative: "Comparative?", superlative: "Superlative?", plural_adj: "Plural / definite?" },
    ukr: { gender: "Який рід (артикль)?", indef_pl: "Множина (неозн.)?", present: "Теперішній час?", past: "Минулий час?", perfect: "Перфект (har …)?", neuter: "Середній рід?", comparative: "Вищий ступінь?", superlative: "Найвищий ступінь?", plural_adj: "Множина / означена?" },
    pl: { gender: "Jaki rodzajnik?", indef_pl: "Liczba mnoga (nieokr.)?", present: "Czas teraźniejszy?", past: "Czas przeszły?", perfect: "Perfekt (har …)?", neuter: "Forma nijaka?", comparative: "Stopień wyższy?", superlative: "Stopień najwyższy?", plural_adj: "Liczba mnoga / określona?" },
    lt: { gender: "Kuris artikelis?", indef_pl: "Daugiskaita (neapibr.)?", present: "Esamasis laikas?", past: "Būtasis laikas?", perfect: "Perfektas (har …)?", neuter: "Bevardė giminė?", comparative: "Aukštesnysis laipsnis?", superlative: "Aukščiausiasis laipsnis?", plural_adj: "Daugiskaita / įvardž.?" },
    lv: { gender: "Kurš artikuls?", indef_pl: "Daudzskaitlis (nenot.)?", present: "Tagadne?", past: "Pagātne?", perfect: "Perfekts (har …)?", neuter: "Nekatrā dzimte?", comparative: "Pārākā pakāpe?", superlative: "Vispārākā pakāpe?", plural_adj: "Daudzskaitlis / noteiktā?" },
    ar: { gender: "أي أداة تعريف؟", indef_pl: "الجمع (نكرة)؟", present: "المضارع؟", past: "الماضي؟", perfect: "(har …) الماضي التام؟", neuter: "صيغة المحايد؟", comparative: "اسم التفضيل (المقارنة)؟", superlative: "اسم التفضيل (الأعلى)؟", plural_adj: "الجمع / المعرفة؟" },
